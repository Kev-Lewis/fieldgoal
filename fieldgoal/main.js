...
function update() {
  ...
  color("black");
  rect(left_post_x - 24, 11, 4, 4);
  color("black");
  rect(left_post_x - 19, 11, 4, 4);
  color("black");
  rect(left_post_x - 14, 11, 4, 4);
  color("black");
  rect(left_post_x - 9, 11, 4, 4);
  color("black");
  rect(left_post_x - 24, 16, 4, 4);
  color("black");
  rect(left_post_x - 19, 16, 4, 4);
  color("black");
  rect(left_post_x - 14, 16, 4, 4);
  color("black");
  rect(left_post_x - 9, 16, 4, 4);
  color("black");
  rect(left_post_x - 24, 21, 4, 4);
  color("black");
  rect(left_post_x - 19, 21, 4, 4);
  color("black");
  rect(left_post_x - 14, 21, 4, 4);
  color("black");
  rect(left_post_x - 9, 21, 4, 4);
  color("black");
  rect(left_post_x - 24, 26, 4, 4);
  color("black");
  rect(left_post_x - 19, 26, 4, 4);
  color("light_black");
  rect(left_post_x - 15, 30, 1, 48);
  color("black");
  rect(left_post_x - 14, 26, 4, 4);
  color("black");
  rect(left_post_x - 9, 26, 4, 4);

  color("black");
  rect(left_post_x + 37, 11, 4, 4);
  color("black");
  rect(left_post_x + 42, 11, 4, 4);
  color("black");
  rect(left_post_x + 47, 11, 4, 4);
  color("black");
  rect(left_post_x + 52, 11, 4, 4);
  color("black");
  rect(left_post_x + 37, 16, 4, 4);
  color("black");
  rect(left_post_x + 42, 16, 4, 4);
  color("black");
  rect(left_post_x + 47, 16, 4, 4);
  color("black");
  rect(left_post_x + 52, 16, 4, 4);
  color("black");
  rect(left_post_x + 37, 21, 4, 4);
  color("black");
  rect(left_post_x + 42, 21, 4, 4);
  color("black");
  rect(left_post_x + 47, 21, 4, 4);
  color("black");
  rect(left_post_x + 52, 21, 4, 4);
  color("black");
  rect(left_post_x + 37, 26, 4, 4);
  color("black");
  rect(left_post_x + 42, 26, 4, 4);
  color("light_black");
  rect(left_post_x + 46, 30, 1, 48);
  color("black");
  rect(left_post_x + 47, 26, 4, 4);
  color("black");
  rect(left_post_x + 52, 26, 4, 4);
